...
function updateMIManagerList(){
    if(blankMI != null){
        ...
        for (let i = 0; i < menuItems.length; i++) {
            ...
            newMIObjName.innerHTML = menuItems[i].name;
            newMIObjPrice.innerHTML = menuItems[i].price;
            newMIObjCtg.innerHTML = menuItems[i].category;
            newMIObjImg.src = menuItems[i].image;
            newMIObjDesc.innerHTML = menuItems[i].description;
            newMIObjIng.innerHTML = menuItems[i].ingredients;
